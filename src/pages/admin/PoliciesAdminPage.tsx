  ...
  if (loading) {
    return (
      <section className="p-6">
        ...
        <div className="mt-7 h-96 animate-pulse rounded-3xl bg-[#eaf0f6]" />
      </section>
    );
  }
    ...
    <section className="p-5 sm:p-7">
      <div>
        ...
        <p className="mt-2 text-sm text-[#707881]">
          Chỉnh sửa nội dung hiển thị tại chân
          trang và trong bước thanh toán.
        </p>
      </div>
      ...
      <div className="mt-7 grid gap-6 xl:grid-cols-[280px_minmax(0,1fr)]">
        <aside className="h-fit rounded-3xl bg-white p-3 shadow-sm">
            ...
            <div className="grid gap-5">
              ...
              <label className="text-sm font-bold">
                ...
                <textarea
                  ...
                  className="mt-2 min-h-[420px] w-full resize-y rounded-2xl border border-[#cfd6dd] bg-[#f7f9ff] p-4 font-normal leading-7 outline-none focus:border-[#006397]"
                  placeholder="Dùng ## ở đầu dòng để tạo tiêu đề mục."
                />
              </label>
